HeroData =
{
	DefaultHero =
	{
		...
		Super =
		{
			...
			DamageTakenMultiplier = 255.00,		-- every 100% of max health taken charges your super by this much
			Active = false,
		},
		RallyHealth =
		{
		...
		EasyModeDamageMultiplierBase = -1.0,
