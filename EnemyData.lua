UnitSetData.Enemies =
{
	...
	HeavyRangedSplitterMinibossSuperElite =
	{
		...
		OnDamagedWeapons = {
			SpawnSplitterFragmentSuperElite = { Requirements = { MaxUnitsByType = { SpawnSplitterFragmentSuperElite = 12 } } },
		},
  ...
  DusaSummon =
  {
	...
	TrainingMelee =
	{
		...
		InteractTextLineSets =
		{
			...
			SkellyBackstory03 =
			{
				...
				{ Cue = "/VO/Skelly_0502", PreLineWait = 2.65, Speaker = "SkellyBackstory",
				...
				{ Cue = "/VO/Skelly_0503", PreLineWait = 0.35,
					EndSecretMusic = true,
					PreLineThreadedFunctionName = "PlayEmoteAnimFromSource", PreLineThreadedFunctionArgs = { Emote = "PortraitEmoteCheerful", DoShake = true, WaitTime = 2.5 },
	...
	Harpy =
	{
		InheritFrom = { "BaseVulnerableEnemy", "BaseBossEnemy"  },
		...
		BossPresentationIntroTextLineSets =
		{
			...
			{
				PlayOnce = true,
				RequiredTextLines = { "FuryAboutPersephoneMeeting02", "PersephoneMeeting04", "FuryEncounterStoryProgress01" },
				RequiredFalseTextLines = { "Ending01" },
				RequiredFalseSupportAINames = { "Alecto" },
			...
			FuryLegendaryKeepsakeReaction01_B =
			{
				...
				{ Cue = "/VO/MegaeraField_0735", Speaker = "NPC_FurySister_01", Portrait = "Portrait_FurySister01_Pleased_01",
					PreLineAnim = "FuryTaunt", PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryLegendaryKeepsakeReaction01 =
			{
				...
				{ Cue = "/VO/MegaeraField_0444", Speaker = "NPC_FurySister_01", Portrait = "Portrait_FurySister01_Pleased_01",
					PreLineAnim = "FuryTaunt", PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
		...
		BossPresentationRepeatableTextLineSets =
		{
			...
			{
				RequiredTextLines = { "MegaeraGift07" },
				{ Cue = "/VO/MegaeraField_0545", Portrait = "Portrait_FurySister01_Pleased_01", Speaker = "NPC_FurySister_01",
					PreLineFunctionName = "StartBossRoomMusic", PreLineAnim = "FuryTaunt", PreLineWait = 0.35,
		...
		BossPresentationPriorityIntroTextLineSets =
		{
			...
			TheseusPactReverted01 =
			{
				...
				{ Cue = "/VO/Theseus_0276",
					...
					PreLineThreadedFunctionName = "PlayPreLineTauntAnimFromSource", PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text = "Nonsense, my friend! For how can one underestimate that which deserves no esteem whatsoever?! Together, now, attack!" },
			},
		...
		BossPresentationTextLineSets =
		{
			...
			MinotaurEncounter06 =
			{
				...
				{ Cue = "/VO/ZagreusField_1757", Portrait = "Portrait_Zag_Defiant_01", Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart", PreLineAnimTarget = "Hero",
					PostLineAnim = "ZagreusTalkDenialReturnToIdle", PostLineAnimTarget = "Hero",
					Text = "You know, you hurt me with this 'short one' business almost as much as with that axe. Why isn't Theseus 'short one'? We're the same height!" },
	...
	Hades =
	{
		...
		BossPresentationIntroTextLineSets =
		{
			...
			LordHadesNoBoonsReaction01 =
			{
				...
				RequiredTextLines = { "Ending01" },
				RequiredAnyTextLines = { "LordHadesEncounter01", "LordHadesEncounter01_B" },
				RequiredFalseGodLoots = { "ZeusUpgrade", "PoseidonUpgrade", "AthenaUpgrade", "AphroditeUpgrade", "AresUpgrade", "ArtemisUpgrade", "DionysusUpgrade", "HermesUpgrade", "DemeterUpgrade" },
			...
			LordHadesAboutFishing01 =
			{
				...
				{ Cue = "/VO/HadesField_0690",
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text = "You mistook my meaning. First, {#DialogueItalicFormat}you {#PreviousFormat}shall have my spear. Then, that thing shall, if it has not yet come to its senses by then. Though, if you vanquish me, I'm certain your uncle shall not mind if you extract it, yourself." },
			},
